       ...
       <div>
        ...
        <div class="container">
            <div class="form-horizontal">
                ...
                <hr />
                <h4>Enter Your User Id and Email. We Will Send you Link To recover Your Password</h4>
                ...
                <div class="form-group">
                     <asp:Label ID="Label2" runat="server" CssClass="col-md-2  control-label" Text=" Email Id :"></asp:Label>
                <div class="col-md-3">
                    <asp:TextBox ID="Email" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="text-danger" ErrorMessage=" Email Id is Reqired" ControlToValidate="Email"></asp:RequiredFieldValidator>
                </div>
                </div>
                 <div class="form-group">
